 ...
 * 
 */
@WebServiceClient(name = "demoService", targetNamespace = "http://service.nareshit.com/", wsdlLocation = "http://localhost:8888/JAX_WS_RI_CONTRACT_FIRST/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName DEMOSERVICE_QNAME = new QName("http://service.nareshit.com/", "demoService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8888/JAX_WS_RI_CONTRACT_FIRST/hello?wsdl");
    ...
    public Demo getDemoPort() {
        return super.getPort(new QName("http://service.nareshit.com/", "demoPort"), Demo.class);
    }
    ...
    public Demo getDemoPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.nareshit.com/", "demoPort"), Demo.class, features);
    }
