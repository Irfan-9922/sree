 ...
 * generated in the com.nareshit.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _NameResponse_QNAME = new QName("http://service.nareshit.com/", "nameResponse");
    private final static QName _Name_QNAME = new QName("http://service.nareshit.com/", "name");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.nareshit.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.nareshit.com/", name = "nameResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.nareshit.com/", name = "name")
