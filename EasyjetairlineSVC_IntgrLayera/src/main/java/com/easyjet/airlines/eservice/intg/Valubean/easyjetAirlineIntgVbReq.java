 ...
 */
public class easyjetAirlineIntgVbReq {
	 private String clientId;
	    ...
	    private Addressreqbeanint address;
	    private String city;
		 ...
		 * @return the address
		 */
		public Addressreqbeanint getAddress() {
			return address;
		}
		/**
		 * @param address the address to set
		 */
		public void setAddress(Addressreqbeanint address) {
		...
		public String toString() {
			return "easyjetAirlineIntgVbReq [clientId=" + clientId + ", channelId=" + channelId + ", requestId="
